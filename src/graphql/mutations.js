...
`;
export const createVoddemo = /* GraphQL */ `
  mutation CreateVoddemo($input: CreateVoddemoInput!) {
    createVoddemo(input: $input) {
      guid
      srcBucket
      srcVideo
      startTime
...
`;
export const updateVoddemo = /* GraphQL */ `
  mutation UpdateVoddemo($input: UpdateVoddemoInput!) {
    updateVoddemo(input: $input) {
      guid
      srcBucket
      srcVideo
      startTime
...
`;
export const deleteVoddemo = /* GraphQL */ `
  mutation DeleteVoddemo($input: DeleteVoddemoInput!) {
    deleteVoddemo(input: $input) {
      guid
      srcBucket
      srcVideo
      startTime
